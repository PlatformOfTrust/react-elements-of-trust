...
1. The usage of identity assets of *Platform of Trust Oy*, including *UI color schemes*, any *single color* or *any combination of colors*; *corporate images*; *Logos* and other supplementary documents under the `Root` path, any `folder` under the *Root* or any `/subfolder` path is restricted and can be used only with express written consent.

2. The code in the repository is *Open Source*.
